...
%By parameterizing the TCN architecture itself, we introduce a new method for creators to design audio effects,
%where model architecture choices are used to explore the space of sonic shaping possibilities.
...
%opening new avenues for exploring creative processing.
